    ...
    def process_full_batch_data(self, data):
        ...
        if self.dataset == 'cora' or self.dataset == 'citeseer':
            data = Data(nodes=nodes, edge_index=data.edge_index, edge_attr=data.edge_attr, x=data.x, y=data.y,
                    ...
                    train_mask5_17=data.train_mask5_17, val_mask5_17=data.val_mask5_17, test_mask5_17=data.test_mask5_17,
                    train_mask3_61=data.train_mask3_61, val_mask3_61=data.val_mask3_61, test_mask3_61=data.test_mask3_61,
...
def create_masks(data, name='cora'):
    ...
    if name == 'cora' or name == 'citeseer':
        ...
        mask5_17 = Random_Nonzero_Masking(data, labels, label_rate=5.17)
        mask3_61 = Random_Nonzero_Masking(data, labels, label_rate=3.61)
        ...
        data.train_mask5_17, data.val_mask5_17, data.test_mask5_17 = mask5_17
        data.train_mask3_61, data.val_mask3_61, data.test_mask3_61 = mask3_61
